...
class FurthestPointSamplingWithDist(Function):
    ...
    def forward(ctx, xyz, npoint):
        ...
        """
        # print(_ext.furthest_point_sampling)
        return _ext.furthest_point_sampling_with_dist(xyz, npoint)
...
furthest_point_sampling_with_dist = FurthestPointSamplingWithDist.apply
...
class QueryAndGroup(nn.Module):
    ...
    def forward(self, xyz, new_xyz, features=None, return_idx=False):
        r"""
        Parameters
        ----------
        xyz : torch.Tensor
